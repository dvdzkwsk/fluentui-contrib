import type { CardPreviewProps as BaseProps, CardPreviewState as BaseState } from '@fluentui/react-card';
 ...
 * @alpha
 */
export type CardPreviewState = BaseState & Required<Pick<CardPreviewProps, 'layout'>>;
