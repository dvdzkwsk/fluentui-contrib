...
import { typographyStyles } from '../../../../../tokens/src';
...
export const cardHeaderClassNames: SlotClassNames<CardHeaderSlots> = {
  root: 'spui-CardHeader',
  header: 'spui-CardHeader__header',
  description: 'spui-CardHeader__description',
  action: 'spui-CardHeader__action',
  image: 'spui-CardHeader__image',
};
