...
export const cardFooterClassNames: SlotClassNames<CardFooterSlots> = {
  root: 'spui-CardFooter',
  action: 'spui-CardFooter__action'
};
...
export const useCardFooterStyles = (state: CardFooterState): CardFooterState => {
  state.root.className = mergeClasses(cardFooterClassNames.root, state.root.className);

  if (state.action) {
    state.action.className = mergeClasses(cardFooterClassNames.action, state.action.className);
  }
